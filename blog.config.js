...
const BLOG = {
    ...
    GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'The quick brown fox jumps over the lazy dog.',
    ...
    // 自定义右键菜单
    CUSTOM_RIGHT_CLICK_CONTEXT_MENU: process.env.NEXT_PUBLIC_CUSTOM_RIGHT_CLICK_CONTEXT_MENU || flase, // 自定义右键菜单，覆盖系统菜单
